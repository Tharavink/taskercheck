        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link href="/dashboard/user" :active="$page.currentRouteName == 'dashboard'">
                                Users
                            </jet-nav-link>
                            <jet-nav-link href="/dashboard/business" :active="$page.currentRouteName == 'business'">
                                Businesses 
                            </jet-nav-link>
                            <jet-nav-link href="/dashboard/service" :active="$page.currentRouteName == 'service'">
                                Services 
                            </jet-nav-link>
                            <jet-nav-link href="/dashboard/request" :active="$page.currentRouteName == 'requests'">
                                Requests 
                            </jet-nav-link>
                        </div>
                    </div>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <jet-responsive-nav-link href="/dashboard/user" :active="$page.currentRouteName == 'dashboard'">
                        Users
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/dashboard/business" :active="$page.currentRouteName == 'business'">
                        Businesses
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/dashboard/service" :active="$page.currentRouteName == 'service'">
                        Services
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/dashboard/request" :active="$page.currentRouteName == 'requests'">
                        Requests
                    </jet-responsive-nav-link>
                </div>
